...
- **Name**: EventsLib
- **Type**: Contract
- **Path**: src/libraries/EventsLib.sol
- **Documentation**: @title EventsLib
   @author Morpho Labs
...
event Withdraw(Id indexed id, address caller, address indexed onBehalf, address indexed receiver, uint256 assets, uint256 shares);
```
