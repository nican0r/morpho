# Function: shortcut_borrow(uint256,uint256,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: TargetFunctions.shortcut_borrow(uint256,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │ │   💬 Args: [no args]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: CryticAsserts.between(uint256,uint256,uint256) (NodeID: 16)
  │ │   💬 Args: [assets_, 0, maxAssets]
  │ │   👁️  Def: internal
  ...
  │   💬 Args: [borrowAmount]
  │   👁️  Def: public
  │ ├─ [2] ⚙️ FUNCTION: CryticAsserts.between(uint256,uint256,uint256) (NodeID: 21)
  │ │   💬 Args: [assets_, 0, maxAssets]
  │ │   👁️  Def: internal
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ManagersTargets.switchActor(uint256) (NodeID: 26)
      💬 Args: [0]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: ActorManager._switchActor(uint256) (NodeID: 27)
        💬 Args: [entropy]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: EnumerableSet.at(struct EnumerableSet.AddressSet,uint256) (NodeID: 28)
          💬 Args: [_actors, entropy]
          👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: EnumerableSet._at(struct EnumerableSet.Set,uint256) (NodeID: 29)
            💬 Args: [set._inner, index]
            👁️  Def: private
```
