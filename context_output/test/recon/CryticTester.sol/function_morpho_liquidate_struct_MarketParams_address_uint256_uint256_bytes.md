# Function: morpho_liquidate(struct MarketParams,address,uint256,uint256,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: MorphoTargets.morpho_liquidate(struct MarketParams,address,uint256,uint256,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
