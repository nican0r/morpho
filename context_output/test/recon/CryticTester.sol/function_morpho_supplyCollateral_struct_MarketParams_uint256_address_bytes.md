# Function: morpho_supplyCollateral(struct MarketParams,uint256,address,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: MorphoTargets.morpho_supplyCollateral(struct MarketParams,uint256,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
