# Function: morpho_borrow(struct MarketParams,uint256,uint256,address,address)
...
```
┌─ [0] ⚙️ FUNCTION: MorphoTargets.morpho_borrow(struct MarketParams,uint256,uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
