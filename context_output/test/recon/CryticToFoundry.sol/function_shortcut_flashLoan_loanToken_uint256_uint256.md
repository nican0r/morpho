# Function: shortcut_flashLoan_loanToken(uint256,uint256)
...
### morpho_flashLoan_clamped_loanToken(uint256)

- **Kind**: internal
- **Source**: 1327:284:67
- **Link**: `test/recon/targets/MorphoTargets.sol:MorphoTargets:morpho_flashLoan_clamped_loanToken(uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: TargetFunctions.shortcut_flashLoan_loanToken(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: MorphoTargets.morpho_flashLoan_clamped_loanToken(uint256) (NodeID: 10)
      💬 Args: [flashLoanAmount]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: FoundryAsserts.between(uint256,uint256,uint256) (NodeID: 11)
    │   💬 Args: [assets_, 0, maxAssets]
    │   👁️  Def: internal
