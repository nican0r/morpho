# Function: check_borrowLessThanSupply(bytes4,address,Id)
...
- **Vm::assume(bool)**
- **IMorpho::totalBorrowAssets(contract IMorpho,Id)**
- **IMorpho::totalSupplyAssets(contract IMorpho,Id)**
...
```
┌─ [0] ⚙️ FUNCTION: HalmosTest.check_borrowLessThanSupply(bytes4,address,Id) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
