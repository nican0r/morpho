# Function: check_lltvSmallerThanWad(bytes4,address,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: HalmosTest.check_lltvSmallerThanWad(bytes4,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
