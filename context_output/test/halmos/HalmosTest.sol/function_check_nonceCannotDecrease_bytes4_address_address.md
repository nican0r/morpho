# Function: check_nonceCannotDecrease(bytes4,address,address)
...
```
┌─ [0] ⚙️ FUNCTION: HalmosTest.check_nonceCannotDecrease(bytes4,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
