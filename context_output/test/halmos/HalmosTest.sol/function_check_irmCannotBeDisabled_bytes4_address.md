# Function: check_irmCannotBeDisabled(bytes4,address)
...
```
┌─ [0] ⚙️ FUNCTION: HalmosTest.check_irmCannotBeDisabled(bytes4,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
